...
v = tk.IntVar()
#v.set(1) 預設值
radiobtn1 = tk.Radiobutton(w, text="Python",padx = 5,variable=v, value=1)
radiobtn2 = tk.Radiobutton(w, text="c++",padx = 5,variable=v, value=2)
radiobtn1.grid(row=0,column=0,sticky=tk.W)
radiobtn2.grid(row=0,column=1,sticky=tk.W)
